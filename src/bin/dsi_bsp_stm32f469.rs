...
pub static FRAMEBUFFER: [TargetPixel; 2 * 800] = [
    TargetPixel { r: 0, g: 0, b: 255 },
    TargetPixel { r: 0, g: 0, b: 255 },
    TargetPixel { r: 0, g: 0, b: 255 },
    TargetPixel { r: 0, g: 0, b: 255 },
    TargetPixel { r: 0, g: 0, b: 255 },
...
pub type TargetPixel = RGB888;

#[link_section = ".frame_buffer"]
static mut FB1: [TargetPixel; NUM_PIXELS] = [TargetPixel { r: 0, g: 0, b: 0 }; NUM_PIXELS];

#[link_section = ".frame_buffer"]
static mut FB2: [TargetPixel; NUM_PIXELS] = [TargetPixel { r: 0, g: 0, b: 0 }; NUM_PIXELS];
...
impl slint::platform::Platform for StmBackend<'_> {
    ...
    fn run_event_loop(&self) -> Result<(), slint::PlatformError> {
        ...
        //fb1[0..800*3].copy_from_slice(FRAMEBUFFER);
        //fb1[0..100].fill(TargetPixel::new(0xFF, 0, 255, 0));

        //fb1[800..900].fill(TargetPixel::new(0xFF, 255,0, 0));
        //fb1[300..600].fill(TargetPixel::new(0, 255, 0));
        //fb1[600..800].fill(TargetPixel::new(0, 0, 255));

        /*
        error!("Framebuffer 0..10: {:#?}", fb1[0..10].as_bytes());
        error!("Framebuffer 250..300: {:#?}", fb1[250..300].as_bytes());
        error!("Framebuffer 300..310: {:#?}", fb1[300..310].as_bytes());
        error!("Framebuffer 600..610: {:#?}", fb1[600..610].as_bytes());
        */
        //fb1[0..NUM_PIXELS / 2].fill(rgb::RGB::<u8>::new(255, 255, 255));
        //fb2[0..NUM_PIXELS / 2].fill(rgb::RGB::<u8>::new(255, 255, 255));

        //ltdc::set_framebuffer(fb1.as_ptr() as *const u32);
        //loop {}
